      ...
      <div className="tooltip-container">
        <div className="tooltip">
          <div className="profile">
            <div className="user">
              <div className="img">
                <img src="arjun.png" alt="" />
              </div>
              <div className="details">
                <div className="name">Ajun Lakshakar</div>
        ...
        <div className="text">
          <a className="icon" href="https://www.linkedin.com/in/arjun-lakshakar-31686b309/"> 
            ...
            <div className="text flex items-center justify-center">LinkedIn</div>
          </a>
        </div>
      </div>
    </StyledWrapper>
